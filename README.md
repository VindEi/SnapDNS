...
| :---------------- | :----------------- | :----------------------------------------------------------------------- |
| **Windows 10/11** | `.exe` (Installer) | Installs both the app and the background system service. _(Recommended)_ |
...
4. _(Optional)_ Pull down your notification bar, edit your Quick Tiles, and add the **SnapDNS** tile for instant toggling!
